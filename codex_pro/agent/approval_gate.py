...
from codex_pro.bus.delivery import DeliveryResult
...
class ApprovalGate:
    ...
    async def _manual_approval_flow(
        ...
        from codex_pro.agent.approval_manual import manual_approval_flow

        return await manual_approval_flow(
            self,
            tool_name,
            arguments,
            sender_id,
    ...
    async def _publish_approval_request(
        ...
        from codex_pro.agent.approval_manual import publish_approval_request

        return await publish_approval_request(
            self, event, request_id, tool_name, guard, pattern_key, arguments, risk,
        )
