...
import type { SettingsSection } from "../../stores/shell";
...
/** Icons matched to docs/design/index.html settings-item SVGs. */
export const SETTINGS_ICONS: Record<SettingsSection, ReactNode> = {
  general: (
    <Icon>
