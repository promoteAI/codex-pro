...
| **Cross-Process Interop** | Inbound A2A JSON-RPC tasks and an outbound delegation tool (`delegate_a2a`, which discovers, dispatches, polls and cancels tasks on remote A2A agents) + MCP client (OAuth and dynamic tool registration) | [MCP](https://codex-pro.io/codex-pro/en/integrations/mcp/) · [A2A](https://codex-pro.io/codex-pro/en/integrations/a2a/) |
