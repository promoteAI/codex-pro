...
metadata:
  codex:
    tags: [Email, IMAP, SMTP, Himalaya, Productivity]
    requires:
      anyBins: [himalaya, python3]
---
...
```bash
export CODEX_EMAIL_HOST=imap.gmail.com
export CODEX_EMAIL_USER=user@gmail.com
export CODEX_EMAIL_PASS=app-password
export CODEX_SMTP_HOST=smtp.gmail.com
export CODEX_SMTP_PORT=587
```
